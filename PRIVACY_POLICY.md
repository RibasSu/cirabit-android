# cirabit Privacy Policy

*Last updated: January 2025*

## Our Commitment

cirabit is designed with privacy as its foundation. We believe private communication is a fundamental human right. This policy explains how cirabit protects your privacy.
...
- **Hybrid Functionality** - cirabit offers two modes of communication:
...
## What Information cirabit Stores
...
During each session, cirabit temporarily maintains:
...
### With Other cirabit Users

When you use cirabit, nearby peers can see:
...
To provide the core functionality of cirabit, we access your device's location data. This access is necessary for the following specific purposes:
...
- **How we use it:** We use this permission strictly to discover other cirabit peers nearby for the "Bluetooth Mesh Chat" mode.
...
cirabit does not knowingly collect information from children. The app has no age verification because it collects no personal information from anyone.
...
cirabit is an open source project. For privacy questions:
- Review our code: https://github.com/sarahsec/cirabit-android
- Open an issue on GitHub
- Join the discussion in public rooms

## Philosophy

Privacy isn't just a feature—it's the entire point. cirabit proves that modern communication doesn't require surrendering your privacy. No accounts, no servers, no surveillance. Just people talking freely.

---

*This policy is released into the public domain under The Unlicense, just like cirabit itself.*
