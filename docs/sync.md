...
Implementation: `com.cirabit.android.sync.PacketIdUtil`.

## GCS Filter (On-demand)

Implementation: `com.cirabit.android.sync.GCSFilter`.
...
Encode/Decode implementation: `com.cirabit.android.model.RequestSyncPacket`.
