# Cirabit Android - Agent Guide

This document provides context, architectural insights, and development standards for AI agents working on the Cirabit Android codebase.

## 1. Project Overview
**Cirabit** is a decentralized, off-grid communication application focused on privacy and censorship resistance. It utilizes mesh networking (primarily Bluetooth LE and Tor/Arti) to enable peer-to-peer messaging without centralized servers.
...
**Root Package:** `com.cirabit.android`
