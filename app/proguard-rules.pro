...
-keep class com.cirabit.android.protocol.** { *; }
-keep class com.cirabit.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.cirabit.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.cirabit.android.favorites.** { *; }
-keep class com.cirabit.android.nostr.** { *; }
-keep class com.cirabit.android.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.cirabit.android.net.RealTorProvider { *; }
