...
object RelayDirectory {
    ...
    private const val ASSET_FILE_URL = "https://cirabit.org/nostr_relays.csv"
    ...
    private val httpClient: OkHttpClient
        get() = com.cirabit.android.net.OkHttpProvider.httpClient()
    ...
    fun closestRelaysForGeohash(geohash: String, nRelays: Int): List<String> {
        ...
        val center = try {
            val c = com.cirabit.android.geohash.Geohash.decodeToCenter(geohash)
            c
        } catch (e: Exception) {
