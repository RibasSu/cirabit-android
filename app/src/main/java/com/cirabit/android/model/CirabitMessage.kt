...
@Parcelize
enum class CirabitMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * CirabitMessage - 100% compatible with iOS version
 */
@Parcelize
data class CirabitMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: CirabitMessageType = CirabitMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): CirabitMessage? {
            try {
                ...
                return CirabitMessage(
                    id = id,
                    sender = sender,
                    content = content,
                    type = CirabitMessageType.Message,
                    timestamp = timestamp,
                    isRelay = isRelay,
