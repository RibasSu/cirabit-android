 ...
 * 
 * This class handles all relay decisions and logic for cirabit packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.cirabit.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: CirabitPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: CirabitPacket, fromPeerID: String): Boolean {
