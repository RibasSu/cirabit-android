...
import com.cirabit.android.mesh.PeerFingerprintManager
import com.cirabit.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.cirabit.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.cirabit.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.cirabit.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a CirabitPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.cirabit.android.protocol.CirabitPacket): com.cirabit.android.protocol.CirabitPacket? {
    ...
    /**
     * Verify a CirabitPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.cirabit.android.protocol.CirabitPacket, publicKey: ByteArray): Boolean {
